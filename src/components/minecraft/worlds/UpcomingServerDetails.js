...
const UpcomingServer = () => {
    return (
        <div className="upcomingServer">
            ...
            <h4>1.19.2</h4>
            <p>Starting Sunday, July 9th, come play on this hardcore modded server (6 lives each). Each life you are given a random Origin which will grant you abilities.
