    ...
    <>
      <div className="MainView">
          ...
          <div style={{marginTop: 180}} className="website-features-wrapper">
              <Link style={{color: "black", textDecoration: "none"}} to="https://mcwardrobe.com">
                  <div className="website-features">
                      <h1>MCWardrobe</h1>
                      <img src={"/images/overview/MCWardrobeLogo.png"} alt={"MCWardrobe"}/>
                      <p>Start editing Minecraft skins at: <br/> <b>mcwardrobe.com</b></p>
                  </div>
              </Link>
              <Link style={{color: "black", textDecoration: "none"}} to="/overview">
                  <div className="website-features" style={{borderWidth:5}}>
                      <h1>Projects</h1>
                      <img style={{backgroundColor:"#202020"}} src={"/images/main/logoTm.svg"} alt={"Projects Overview"}/>
